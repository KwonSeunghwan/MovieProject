...
<body>
	...
	<form action="idCheck.do" method="get" name="frm">
		아이디 <input type="text" name="mem_id" id="mem_id" value="${mem_id}">
		<input type="submit" value="중복 체크" onclick="return idJoinCheck()"><br>
	</form>
		<!-- 중복된 사용자 : result(1) -->
		<c:if test="${result == 1}">
			<script type="text/javascript">
				opener.document.frm.mem_id.value = "";	// opener : joinForm.jsp
